...
/**
 * NOVAS FUNCOES PARA TRANSFORMAÇÃO AF -> GR
 */
AFND.prototype.serialize2 = function() {
  return {transitions: this.transitions};
};
  
AFND.prototype.encode = function(){
  return JSON.stringify(this.serialize2());
}
  
AFND.prototype.finais = function(){
  return this.acceptStates;
 }

 AFND.prototype.getTr = function(){
